    ...
    \item[\underline{WORK EXPERIENCE}] \hfill
		\begin{description}
            \item[RetailOps - Software Engineer] \hfill \textbf{2014-2016}\\
                \hspace{-9mm}Responsible for full-stack web projects in the Retail and E-Commerce space. The complexity \\of the industry
                provided an enriching experience in modular design and implementation.
