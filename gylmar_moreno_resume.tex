...
\begin{document}
    ...
    \begin{description}
        \item[\textbf{SUMMARY}] \hfill
            \\[-.4cm]
            \noindent\rule{\linewidth}{1.0pt}
            Designs, implements, monitors and maintains
            full-stack distributed applications in different environments.
        \item[\textbf{SKILLS}] \hfill
            \\[-.4cm]
        ...
        \item[\textbf{ENGINEERING EXPERIENCE}] \hfill
            \\[-.4cm]
	...
	\iffalse
        ...
        \item[\textbf{EXTRACURRICULAR}] \hfill
            \\[-.4cm]
            \rule{\linewidth}{1.0pt} % Add this line for a horizontal rule
            \begin{tabular}{l|l|l}
