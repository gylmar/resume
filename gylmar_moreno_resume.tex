...
\begin{document}
    ...
    \begin{description}
        \item[\underline{OBJECTIVE}] Innovative software engineer with expertise in designing and implementing distributed application systems. Seeking a challenging role to leverage my skills in AWS, backend development, and team leadership to
        drive impactful technological solutions.
